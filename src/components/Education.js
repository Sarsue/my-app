...
import carletonunilogo from '../carletonunilogo.jpg';
import pmilogo from '../pmi-logo.gif'
          ...
          {profile.studies.map(function (study, i) {
            return <Media key={i}>
              <Media left top href={study.url}>
                <Media object src={carletonunilogo} alt={study.institute}/>
              </Media>
              <Media body>
                <Media heading>
          ...
          {profile.certifications.map(function (certification, i) {
            ...
            return <Media key={i}>
              <Media left top href={certification.url}>
                <Media object src={pmilogo} alt={certification.title}/>
              </Media>
              <Media body>
                <Media heading>
